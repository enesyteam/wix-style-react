...
import { tooltipNextTestkitFactory } from '../../../testkit/protractor';
...
describe('TooltipNext', () => {
  ...
  const createDriver = async (dataHook = storySettings.dataHook) => {
    const driver = tooltipNextTestkitFactory({ dataHook });

    await waitForVisibilityOf(
      await driver.element(),
      `Cannot find <TooltipNext/> component with dataHook of ${dataHook}`,
    );
