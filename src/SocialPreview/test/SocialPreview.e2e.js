...
import { socialPreviewTestkitFactory } from '../../../testkit/protractor';
...
describe('SocialPreview', () => {
  ...
  const createDriver = async (dataHook = storySettings.dataHook) => {
    const driver = socialPreviewTestkitFactory({ dataHook });

    await waitForVisibilityOf(
      await driver.element(),
      `Cannot find <SocialPreview/> component with dataHook of ${dataHook}`,
    );
